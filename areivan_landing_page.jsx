...
function IconBrain({ className = "" }) {
  return (
    ...
    >
      <path
        d="M9 4a3 3 0 0 0-3 3v.4A3.5 3.5 0 0 0 4 14a3 3 0 0 0 3 3h2V4Z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinejoin="round"
      />
      <path
        d="M15 4a3 3 0 0 1 3 3v.4A3.5 3.5 0 0 1 20 14a3 3 0 0 1-3 3h-2V4Z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinejoin="round"
      />
      <path
        d="M9 9h3m0 0V6m0 3h3m-6 5h3m0 0v4m0-4h3"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
...
function IconTrophy({ className = "" }) {
  return (
    ...
    >
      ...
      />
      <path
        d="M8 6H5a2 2 0 0 0 0 4h3M16 6h3a2 2 0 0 1 0 4h-3"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
      <path
        d="M12 12v5m-4 3h8m-6-3h4"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
...
function IconMap({ className = "" }) {
  return (
    ...
    >
      <path
        d="M4 6.5 9 4l6 2.5 5-2.5v13.5L15 20l-6-2.5L4 20V6.5Z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinejoin="round"
      />
...
function IconLinkedIn({ className = "" }) {
  return (
    ...
    >
      ...
      />
      <path
        d="M7 11v6M7 7v.01M11 11v6m3-6v3a3 3 0 0 0-3-3v-1a2 2 0 0 1 2-2 2 2 0 0 1 2 2v2"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function RoboticsPage() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-white text-slate-950">
            ...
            return (
              ...
              >
                <div className="grid gap-0 lg:grid-cols-[0.95fr_1.05fr]">
                  ...
                  <div
                    id={`${buildId}-process`}
                    className="bg-slate-950 p-6 text-white md:p-8"
                  >
          ...
          <div className="grid gap-10 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              <p className="text-sm font-black uppercase tracking-[0.28em] text-sky-300">
                AREIVAN robotics lab
              </p>
              <h2 className="mt-4 max-w-3xl text-4xl font-black tracking-tight md:text-5xl">
                Interested in robotics or automation?
              </h2>
              <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-300">
                I’m building robotics and industrial software projects around
      ...
      <footer className="border-t text-slate-950 py-10 lg:px-8">
        <div className="mx-auto flex max-w-7xl flex-col gap-3 text-sm text-slate-600 md:flex-row md:items-center md:justify-between">
          <div>
            <p className="font-black tracking-tight border-slate-600">
              Built by Areivan
            </p>
...
export default function AreivanLandingPage() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-white text-slate-950">
      ...
      >
        <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
          <div>
            ...
            <p className="mt-5 text-lg leading-8 text-slate-600">
              AREIVAN exists to turn practical problems in learning, mobility
              and robotics into products that feel fast, clear and ready to
              grow.
            </p>
          </div>
            ...
            <div className="mt-8 rounded-[1.5rem] bg-slate-950 p-5 text-white">
              ...
              <div className="mt-5 space-y-4">
                {roadmap.map((item) => (
                  <div
                    key={item.label}
                    className="border-l border-sky-300/30 pl-4"
                  >
                    <p className="text-sm font-black text-sky-200">
                      {item.label}
                    </p>
        ...
        <div className="overflow-hidden rounded-[2rem] bg-slate-950 p-8 text-white shadow-2xl shadow-slate-900/20 transition duration-500 hover:-translate-y-1 hover:shadow-sky-500/10 motion-reduce:transition-none motion-reduce:hover:translate-y-0 md:p-12">
          <div className="grid gap-10 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              ...
              <h2 className="mt-4 max-w-3xl text-4xl font-black tracking-tight md:text-5xl">
                Built by Areivan. Designed for products that actually work.
              </h2>
              <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-300">
                Explore the ecosystem, review the code, or connect to
                collaborate on software, robotics and industrial tools.
              </p>
            </div>
            <div className="flex flex-col gap-3 sm:flex-row lg:flex-col">
              <button
      ...
      <footer className="border-t bg-gradient-to-r from-slate-900 to-slate-100 px-6 py-10 lg:px-8">
        <div className="mx-auto flex max-w-7xl flex-col gap-3 text-sm text-slate-500 md:flex-row md:items-center md:justify-between">
          <div>
            <p className="font-black tracking-tight text-slate-50">
              Built by Areivan
            </p>
            <p className="mt-1">Robotics engineering student</p>
          </div>
